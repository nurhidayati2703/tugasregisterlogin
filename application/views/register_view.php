                ...
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="<?php echo base_url('Register/registerUser');?>" method="post">
                            ...
                            <div class="form-group">
                                <label for="nis"><i class="zmdi zmdi-account-o"></i></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="cpassword" id="password" placeholder="Repeat your password" />
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="signup" id="signup" class="form-submit" name="register" value="Register">
                                <p>Already Registered.<a href="<?= base_url('Home/Login');?>">Login</a></p>
                            </div>
                        </form>
                    </div>
                    <div class="signup-image">
                        <figure><img src="<?= base_url('asset')?>/images/signup-image.jpg" alt="sing up image"></figure>
